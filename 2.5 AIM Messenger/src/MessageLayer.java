...
public class MessageLayer {
	...
	/**
	 * Create a new MessageLayer using connection as the underlying connection.
	 * 
	 * @param connection
	 ...
	 * Log in.
	 * 
	 * This assumes that the underlying connection is already properly connected.
	 * 
	 * @param username
	 *            the username to log in. This must match the username used to connect to the server.
	 * @param password
	 *            the username's plain-text password.
	 * @throws IOException
	 *             if there is an underlying problem with the connection.
	 * @throws SignOnException
	 *             if the server does not send a SIGN_ON message.
	 * @throws AIMErrorException
	 *             if the server sends a TOC error.
	 **/
	 ...
	 * 
	 * @throws IOException
	 *             if there is an underlying networking problem
	 * @throws AIMErrorException
	 *             if the server sent an error message.
	 * @return a new TOCMessage sub-class representing the message received from the server.
	 **/
