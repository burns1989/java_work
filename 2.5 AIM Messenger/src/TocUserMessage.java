...
/**
 * A TocUserMessage abstracts the behavior of any TOC message that has a user list as its argument.
 * 
 * The TOC protocol message for all user messages is the same: &quot;TOC_COMMAND userlist...&quot; . Therefore, this
 * class provides a toWireFormat that properly writes the message. However, it requires all sub-classes to provide the
 * TOC_COMMAND to start the protocol message.
 * 
 **/
abstract public class TocUserMessage extends TOCMessage {
	 ...
	 * 
	 * @param users
	 *            the list of users. All elements must be Strings. This uses the list as given; it does not clone it.
	 **/
